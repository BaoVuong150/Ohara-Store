using Ohara.Modules.Users;
using Ohara.Modules.Auth;
...
namespace Ohara.Shared.Extensions;
...
public static class ServiceExtensions
{
    ...
    public static IServiceCollection AddApplicationServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddExceptionHandler<Ohara.Shared.Exceptions.GlobalExceptionHandler>();
